...
import com.moordash.dto.*;
import com.moordash.entity.*;
import com.moordash.exception.AddressBookBusinessException;
import com.moordash.exception.OrderBusinessException;
import com.moordash.exception.ShoppingCartBusinessException;
import com.moordash.mapper.*;
import com.moordash.result.PageResult;
import com.moordash.service.OrderService;
import com.moordash.utils.HttpClientUtil;
import com.moordash.utils.WeChatPayUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Value("${moordash.shop.address}")
    private String shopAddress;

    @Value("${moordash.baidu.ak}")
    private String ak;
